        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center mb-6">
              <div className="relative">
                ...
                <button
                  ...
                  disabled={loading}
                  className="absolute bottom-0 right-0 bg-amber-700 hover:bg-amber-800 text-white rounded-full p-2 shadow-lg transition-colors disabled:bg-gray-400"
                >
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Link
                href="/changePass"
                className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-3 rounded-lg text-center transition-colors"
              >
                Đổi mật khẩu
              </Link>
            </div>
