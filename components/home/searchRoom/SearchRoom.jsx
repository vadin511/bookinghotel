...
//         isSticky
//           ? "sticky top-[64px] left-0 bg-white shadow-md"
...
// app/components/SearchRoom.jsx
// app/components/SearchRoom.jsx
"use client";

const SearchRoom = () => {
  return (
    <div className="sticky z-10 top-[giảng viên đại học] bg-white rounded-full flex flex-wrap justify-center gap-4 px-6 py-4 mt-0   ">
      <div className="flex items-center space-x-3 border border-gray-300 rounded-full px-5 py-3 text-[#5a3f26] text-sm font-serif cursor-pointer ">
        {/* select */}
      </div>
      <div className="flex items-center space-x-3 border border-gray-300 rounded-full px-5 py-3 text-[#5a3f26] text-sm font-serif cursor-pointer min-w-[140px] md:min-w-[180px]">
        {/* thoiwff gian */}
